 ...
 */
public class NotiziaAdapter extends BaseAdapter/*estendo
la classe BaseAdapter ed implemento i suoi metodi astratti*/ {

    private ArrayList<Notizia> mObjects;
    private Context mContext;

    public NotiziaAdapter(Context aContext, ArrayList<Notizia> aObjects) {
        mContext = aContext;
        mObjects = aObjects;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Notizia vNotizia = (Notizia) getItem(i);//tramite il metodo getItem recuperiamo la notizia nella posizione i
        ...
        vViewHolder.mCorpo.setText(vNotizia.getmCorpo());//setto il testo nelle 2 textview
        return view;
    }
}
